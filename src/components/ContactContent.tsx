    ...
    <div className="text-zinc-700 dark:text-zinc-300 dark:bg-zinc-700 flex flex-col items-center font-body-sans px-12">
      ...
      <div className="mt-10 font-body-sans text-2xl">
        ...
        <form
          ...
          method="POST"
          name="email-form"
          className="flex flex-col gap-1 pt-4 pb-20"
        >

          <label htmlFor="name" className="font-semibold text-xl">Name:</label>
          <input type="text" name="name" id="name" placeholder="Your name here" className="w-fit rounded-md bg-zinc-300 focus:ring-2 hover:ring-2 hover:ring-zinc-600 outline-none ring-zinc-900 transition-all duration-150 py-2 px-4 text-base mb-2" />
          

          <label htmlFor="msg" className="font-semibold text-xl">Message:</label>
          <input type="text" name="msg" id="msg" placeholder="Type your message here" className="w-50% h-24 rounded-md bg-zinc-300 focus:ring-2 hover:ring-2 hover:ring-zinc-600  outline-none ring-zinc-900 transition-all duration-150 px-4 text-base mb-2" />

          <button className="bg-zinc-600 text-zinc-300 rounded-md w-28 py-1 px-2 m-auto">Submit</button>
        </form>
      </div>
    </div>
  )
