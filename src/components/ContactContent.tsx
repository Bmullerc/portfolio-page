    ...
    <div className="text-zinc-700 dark:text-zinc-300 dark:bg-zinc-700 flex flex-col items-center font-body-sans px-12">
      ...
      <div className="mt-10 font-body-sans lg:text-2xl text-xl">
        ...
        >
          ...
          <input type="text" name="msg" aria-multiline id="msg" required placeholder="Your message here" className="w-50% h-24 rounded-md bg-zinc-300 focus:ring-2 hover:ring-2 dark:hover:ring-4 outline-none ring-zinc-50 transition-all duration-150 px-4 text-base mb-2" />
