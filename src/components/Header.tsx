...
export function Header() {
  return (
    <motion.header
      className="h-screen lg:px-32 px-8 lg:w-2/5 w-full flex flex-col lg:flex-row place-items-center justify-center pt-20 lg:pt-0">
      <motion.div
        initial={{ y: "200vh" }}
        animate={{ y: 0 }}
        exit={{ y: "-100vh" }}
        transition={{ delay: .7, duration: 1, type: "spring", damping: 25, stiffness: 250 }}
        className="px-4 flex flex-col gap-3 font-title-sans font-bold border-r-8 border-zinc-500"
      >
